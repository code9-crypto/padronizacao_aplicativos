...
public class MainViewController {
	// Instanciando a classe para acessar alguns métodos
	Features tools = new Features();

	// Texto para formatação referente aos programas se estão instalados ou não
	@FXML
	protected Label lblCheckPlano;
	...
	private void onBtInstall7zipAction() {
		...
		tools.instalaApp(fileName, folderName, strPath, lblCheck7zip);
	}
	...
	private void onBtInstallAdobeApiAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctFolder);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckAdobePPAPI);
	}
	...
	private void onBtInstallAdobePluginAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctFolder);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckAdobePlugin);
	}
	...
	private void onBtInstallAdobeReaderAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctFolder);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckAdobeReader);
	}
	...
	private void onBtInstallAtualizacaoAdobeReaderAction() {
		...
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckAtualizacaoAdobeReader);
	}
	...
	private void onBtInstallAdobeShockWaveAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckAdobeShockwave);
	}
	...
	private void onBtInstallGoogleChromeAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckChrome);
	}
	...
	private void onBtInstallClienteOCSAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckOCS);
	}
	...
	private void onBtInstallHpScanTwainAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckHPScan);
	}
	...
	private void onBtInstallInternetExplorerAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckIE);
	}
	...
	private void onBtInstallJavaRuntimeAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckJavaRuntime);
	}
	...
	private void onBtInstallLibreOfficeAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckLibreOffice);
	}
	...
	private void onBtInstallLojaDeAppsAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckLojaApp);
	}
	...
	private void onBtInstallMozillaFirefoxAction() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckMozilla);
	}
	...
	private void onBtInstallPDF24Creator() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckPDF24);
	}
	...
	private void onBtInstallSamsungEasyDocumentCreator() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckSamsungEasyDocument);
	}
	...
	private void onBtInstallScanBack() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckScanBack);
	}
	...
	private void onBtInstallSilverlight() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckSilverlight);
	}
	...
	private void onBtInstallTrenAntivirus() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckTrendAntivirus);
	}
	...
	private void onBtInstallUltraVNC() {
		...
		String folderName = FolderOrFileFinder.searchFolder(strPath, correctPath);
		String fileName = FolderOrFileFinder.searchFile(strPath, folderName);
		tools.instalaApp(fileName, folderName, strPath, lblCheckVNC);
	}
	...
	public void onBtUpdate7zip() throws InvocationTargetException {
		...
		String fileName = Features.pegaArquivoLocal(strPath);
		...
		String strPathRemoteFile = "\\\\dados\\seplan\\detic_coengi_seserc__softwares\\compactadores\\7zip\\"
				+ remoteFolder;
		String remoteFileServer = Features.pegaArquivoRemota(strPathRemoteFile);

		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "7zip";
		String pastaPadrao = "7zip_padrao_atualizado";
		String pastaGenerica = "compactadores";
		Features.exibeMensagem(fileName, remoteFileServer, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	...
	public void onBtUpdateAdobeShockWavePlayer() {
		...
		String fileName = Features.pegaArquivoLocal(strLocalPath);
		...
		String strRemotePath = "\\\\dados\\seplan\\detic_coengi_seserc__softwares\\plugins_e_complementos\\adobe_shockwave\\"
				+ remoteFolder;
		String remoteFile = Features.pegaArquivoRemota(strRemotePath);

		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "adobe_shockwave";
		String pastaPadrao = "adobe_shockwave_player_padrao_atualizado";
		String pastaGenerica = "plugins_e_complementos";
		Features.exibeMensagem(fileName, remoteFile, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateGoogleChrome() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "google_chrome";
		String pastaPadrao = "google_chrome_padrao_atualizado";
		String pastaGenerica = "navegadores";
		Features.exibeMensagem(fileName, remoteFile, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateClienteOCS() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "cliente_ocs";
		String pastaPadrao = "cliente_ocs_padrao_atualizado";
		String pastaGenerica = "inventario";
		Features.exibeMensagem(fileName, remoteFile, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateFreePDF() {
		...
		String fileLocalName = Features.pegaArquivoLocal(strLocalPath);
		...
		String strRemotePath = "\\\\dados\\seplan\\detic_coengi_seserc__softwares\\escritorio\\freepdf\\"
				+ remoteFolder;
		String remoteFileName = Features.pegaArquivoRemota(strRemotePath);

		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "freepdf";
		String pastaPadrao = "freepdf_padrao_atualizado";
		String pastaGenerica = "escritorio";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateHPScanTwain() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "hp_scan_twain";
		String pastaPadrao = "hp_scan_twain_padrao_atualizado";
		String pastaGenerica = "impressao";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateInternetExplorer() {
		...
		String remoteFileName = Features.pegaArquivoRemota(strRemotePath);
		String remoteFolder = "internet_explorer-v11-win_7-64bits";

		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "internet_explorer";
		String pastaPadrao = "internet_explorer_padrao_atualizado";
		String pastaGenerica = "navegadores";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateJavaRuntime() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "java_runtime";
		String pastaPadrao = "java_runtime_padrao_atualizado";
		String pastaGenerica = "plugins_e_complementos";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	public void onBtUpdateLibreOffice() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "libre_office";
		String pastaPadrao = "libre_office_padrao_atualizado";
		String pastaGenerica = "escritorio";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	...
	public void onBtUpdateMozillaFirefox() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "mozilla_firefox";
		String pastaPadrao = "mozilla_firefox_padrao_atualizado";
		String pastaGenerica = "navegadores";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	}
	...
	private void onBtUpdatePDF24Creator() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "pdf24_creator";
		String pastaPadrao = "Pdf24Creator_padrao_atualizado";
		String pastaGenerica = "escritorio";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	...
	private void onBtUpdateSamsungEasyDocumentCreator() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "samsung_easy_document_creator";
		String pastaPadrao = "easy_document_creator_padrao_atualizado";
		String pastaGenerica = "impressao";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	...
	private void onBtUpdateSilverlight() {
		...
		String strRemotePath = "\\\\dados\\seplan\\detic_coengi_seserc__softwares\\plugins_e_complementos\\silverlight\\"
				+ remoteFolder;
		String remoteFileName = Features.pegaArquivoLocal(strRemotePath);

		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "silverlight";
		String pastaPadrao = "silverlight_padrao_atualizado";
		String pastaGenerica = "plugins_e_complementos";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
	...
	private void onBtUpdateUltraVNC() {
		...
		// Chamando o método que exibirá para o usuário a mensagem
		String pasta = "ultravnc";
		String pastaPadrao = "ultravnc_padrao_atualizado";
		String pastaGenerica = "conexao_remota";
		Features.exibeMensagem(fileLocalName, remoteFileName, remoteFolder, pasta, pastaPadrao, pastaGenerica);
